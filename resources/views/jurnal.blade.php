...
<!-- Mirrored from themesbrand.com/agroxa/layouts/blue/form-advanced.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 09 Feb 2022 06:33:07 GMT -->
<head>
                            ...
                            <div class="user-info w-100">
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><a href="{{ url('/profil') }}" class="dropdown-item"><i class="mdi mdi-account-circle text-muted me-2"></i>
                            ...
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <div class="page-title">
                                        <h4 class="mb-0 font-size-18">SMK NEGERI 1 TAMBAKBOYO</h4>
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="col-12">
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <!-- End Row -->
                                                 <div class="mb-2 row">
                                                    <label for="example-date-input" class="col-md-2 col-form-label">Ringkasan Kegiatan :</label>
                                                    <div class="col-md-5">
                                                ...
                                                <!-- End Row -->
                                                 <div class="mb-2 row">
                                                    <label for="example-date-input" class="col-md-2 col-form-label">Hasil Kegiatan :</label>
                                                    <div class="col-md-5">
                                                        <textarea required class="form-control" rows="2"></textarea>
                                                    </div>
                                                </div>
                                                ...
                                                <form method="post" enctype="multipart/form-data">
                                                    <div>
                                                      <label for="file"><b>Foto Kegiatan</b></label>
                        ...
                        <div class="row">
                            <div class="col-sm-12 text-center">
                                <script>document.write(new Date().getFullYear())</script> ©  <span
                                    class="d-none d-sm-inline-block">- TUBAN <i class="mdi mdi-heart text-primary"></i> by
                                    @Pandawa.</span>
                            </div>
...
<!-- Mirrored from themesbrand.com/agroxa/layouts/blue/form-advanced.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 09 Feb 2022 06:33:09 GMT -->
</html>
            ...
            <div class="main-content">
                <div class="page-content ">
                    <div class="container-fluid">
                            ...
                            <div class="col-15">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <div class="page-title">
                                        <h4 class="mb-3 font-size-18">SMK NEGERI 1 TAMBAKBOYO</h4>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <form action="{{ url('editjurnal/'.$data->id) }}" method="post" enctype="multipart/form-data">
                            @csrf
                                    ...
                                    <div class="col-12">
                                        <div class="col-15">
                                            <div class="card">
                                                <div class="card-body">
                                                    <p>
                                                    <h4 class="card-title">EDIT JURNAL</h4><br>
                                                    <!-- End Row -->
                                                    <div class="mb-3 row">
                                                        <label for="example-date-input" class="col-md-2 col-form-label" >Tanggal :</label>
                                                        <div class="col-md-10">
                                                            <input class="form-control" type="date" value="{{ $data->tanggal }}" data-date-format="DD/MMM/YYYY"
                                                    ...
                                                    <div class="mb-3 row">
                                                        ...
                                                        <div class="col-md-10">
                                                            <textarea required class="form-control" rows="2" name="ringkasan_kegiatan" value="">{{ $data->ringkasan_kegiatan }}</textarea>
                                                        </div>
                                                    </div>
                                                    <!-- End Row -->
                                                    <div class="mb-3 row">
                                                        ...
                                                        <div class="col-md-10">
                                                            <textarea required class="form-control" rows="2" name="hasil" value="">{{ $data->hasil }}</textarea>
                                                        </div>
                                                    </div>
                                                    <!-- End Row -->
                                                    <div>
                                                        <label class="col-md-2" for="file"><b>Foto Kegiatan</b></label>
                                                        <img width="150px" src="{{ url('foto/'.$data->foto) }}">

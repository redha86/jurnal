                                    ...
                                    <div class="col-12">
                                        <div class="col-15">
                                            <div class="card">
                                                <div class="card-body">
                                                    <p>
                                                    <h4 class="card-title">JURNAL HARIAN</h4><br>
                                                    <!-- End Row -->
                                                    <div class="mb-3 row">
                                                        <label for="example-date-input" class="col-md-2 col-form-label" >Tanggal :</label>
                                                        <div class="col-md-10">
                                                            <input class="form-control" type="date" value="dd/mm/yyyy" data-date-format="DD/MMM/YYYY"
                                                    ...
                                                    <div class="mb-3 row">
                                                        ...
                                                        <div class="col-md-10">
                                                            <textarea required class="form-control" rows="2" name="ringkasan_kegiatan"></textarea>
                                                        </div>
                                                    </div>
                                                    <!-- End Row -->
                                                    <div class="mb-3 row">
                                                        ...
                                                        <div class="col-md-10">
                                                            <textarea required class="form-control" rows="2" name="hasil"></textarea>
                                                        </div>
                                                    </div>
                                                    <!-- End Row -->
                                                    <div>

            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{{ url('humasoft') }}">HUMMASOFT</a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseOne" class="collapse" aria-labelledby="headingOne"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="{{ url('rekapabsen') }}">Rekap Absen</a>
                    </div>
                </div>
            </li>
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="col-2 mx-auto mb-3">
                            <img src="assets/img/undraw_profile.svg" width="125px" class="rounded-circle center mx-auto">
                        </div>  
                        <table class="col-lg-6 mx-auto mb-3" border="1">
                            <tr class="text-center">
                                <th colspan="3"> Detail Siswa</th>
                            </tr>
                            <tr>
                                <th class="text-center" style="width: 40%">Nama Siswa</th>
                                <td class="text-center"style="width: 5%">:</td>
                                <td class="text-center" style="width: 40%">Aldi Afendi</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td class="text-center">:</td>
                                <td class="text-center">Hummasoft</td>
                            </tr>
                            <tr>
                        ...
                        <div class="mx-auto mb-3">
                            <a href="#" class="fas fa-edit bg-success text-light fs-4 p-1 rounded"><b>Edit</b></a>
                            <a href="#" class="fas fa-undo-alt bg-warning text-light fs-4 p-1 rounded">Restart</a>
                        </div>
                    </div>
                </div>
                <!-- /.container-fluid -->

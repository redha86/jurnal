            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="page-title">
                        <h4 class="mb-3 font-size-15 font-weight-bold">EDIT PERUSAHAAN </h4>
                        <ol class="breadcrumb">
                    ...
                    <!--tampilan-->
                    <form action="{{ url('editperusahaan/'.$data->id) }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="row my-3">
                        <div class="col-lg-6 mx-auto">
                                <div class="card position-relative">
                                    <div class="card-body border-left-primary">
                                        ...
                                        <div class="mb-3">
                                            <b><label class="form-label">Nama Perusahaan</label></b>
                                            <div>
                                                <input type="text" class="form-control" required
                                                    data-parsley-minlength="255" placeholder="" id="" name="nama_perusahaan" value="{{ $data->nama_perusahaan }}">
                                            </div>
                                        </div>
                                        <div class="font-weight-bold">Tanggal Magang</div>
                                        <div class="input-group mb-3">
                                            <div class="col-lg-5">
                                                <input class="form-control" type="date" value="{{ $data->tanggal_awal }}"
                                                    id="" name="tanggal_awal">
                                            </div>
                                            <label class="input-group-text" for="inputGroupSelect01">S/D</label>
                                            <div class="col-lg-5">
                                                <input class="form-control" type="date" value="{{ $data->tanggal_akhir }}"
                                                    id="" name="tanggal_akhir">
                                            </div>
                                        </div>

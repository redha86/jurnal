...
<body id="page-top">
            ...
            <li class="nav-item active">
                ...
                <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="{{ url('Rpl') }}">RPL</a>
                ...
                <div class="container-fluid">
                    ...
                    <div class="page-title">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">Data Kelas RPL</li>
                        </ol>
                    </div>
                    <!--tambah-->
                                    ...
                                    <tbody>
                                        ...
                                        @foreach($users as $user)
                                            <tr>
                                                ...
                                                <td class="text-center">{{ $user->tempat }}</td>
                                                <td class="text-center">{{ $user->name }}</td>
                                                <td class="text-center">{{ $user->password }}</td>
                                                <td class="text-center">
                                                    <a href="{{ url('detail') }}" class="fas fa-folder-open bg-warning text-light fs-4 p-1 rounded"></a>
    ...
    <script src="{{ asset('tampilan/js/demo/datatables-demo.js') }}"></script>

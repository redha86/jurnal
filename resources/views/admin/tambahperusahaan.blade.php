            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="page-title">
                        <h4 class="mb-3 font-size-15 font-weight-bold">TAMBAH PERUSAHAAN </h4>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript: void(0);">SMK NEGERI 1 TAMBAKBOYO</a></li>
                            <li class="breadcrumb-item"><a href="javascript: void(0);">Tambah Perusahaan Baru</a></li>
                        </ol>
                    </div>                   
                    <!--tampilan-->
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div>
                                                <input type="text" class="form-control" required
                                                    data-parsley-minlength="255" placeholder="" id="" name="nama_perusahaan">
                                            </div>
                                        </div>
                                        <div class="font-weight-bold">Tanggal Magang</div>
                                        <div class="input-group mb-3">
                                            <div class="col-lg-5">
                                                <input class="form-control" type="date" value="2022-01-03"
                                                    id="" name="tanggal_awal">
                                            </div>
                                            <label class="input-group-text" for="inputGroupSelect01">S/D</label>
                                            <div class="col-lg-5">
                                                <input class="form-control" type="date" value="2022-07-03"

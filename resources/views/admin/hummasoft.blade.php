            ...
            <li class="nav-item active">
                ...
                <div id="collapseUtilities" class="collapse show" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="{{ url('hummasoft') }}">HUMMASOFT</a>
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-center mb-2">
                                                <img src="assets/img/undraw_profile.svg" width="50px" class="rounded-circle mx-auto">
                                            </div>
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1 text-center">
                                                Nama : Aldi Afendi</div>
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1 text-center">
                                                NISN : 0123456789</div>
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1 text-center">
                                                KELAS : RPL</div>
                                            ...
                                            <div class="text-center">
                                                <a href="detail.html" class="fas fa-user bg-success text-light fs-4 p-1 rounded"><b>View</b></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>

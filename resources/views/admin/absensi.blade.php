            ...
            <li class="nav-item active">
                ...
                <div id="collapseOne" class="collapse show" aria-labelledby="headingOne"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="{{ url('absensi') }}">Absensi</a>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="page-title">
                        <h4 class="mb-3 font-size-15 font-weight-bold">Data Absensi  </h4>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript: void(0);">SMK NEGERI 1 TAMBAKBOYO</a></li>
                            <li class="breadcrumb-item"><a href="javascript: void(0);">Absensi Hari Ini</a></li>
                        </ol>
                    </div>                   
                                        <!-- Content Row -->
                                        <div class="row">
                                                        ...
                                                        <table id="datatable-buttons"
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    <td class="text-center">07.00 WIB</td>

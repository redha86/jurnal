        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3 mb-1">
                            <h6 class="m-0 font-weight-bold text-primary">Rekap Data Jurnal Siswa</h6>
                        </div>
                        <div class="row">
                            ...
                            <div class="input-group mb-3 col-lg-6">
                                ...
                                <option value="3">Tata Busana </option>
                                <option value="4">Teknik Pemesinan</option>
                                <option value="5">Teknik Kendaraan Ringan</option>
                                <option value="6">Teknik Pemesinan Kapal</option>
                                <option value="7">Teknik Instalasi Tenaga Listrik</option>
                                </select>
                            </div>
                            <div class="mx-auto">
                                <a href="#" class=" fas fa-save btn btn-sm btn-success shadow-sm fs-14 p-2"><b>
                                    Tampilkan</b>
                                </a>
                                <a href="#" class=" fas fa-folder-open btn btn-sm btn-warning shadow-sm fs-14 p-2"><b>
                                    Semua</b>
                                </a>
                            </div>
                        </div>
                                ...
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        <tr>
                                            <th>1</th>
                                            <th>Aldi Afendi</th>
                                            <th> Rabu,25-05-2022</th>
                                            <th>RPL</th>
                                            <th>melanjutkan projek</th>
                                            <th>menambahkan fitur absen</th>
                                            <th>#</th>
                                        </tr>
                                    </tbody>
                                </table>
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3 mb-1">
                            <h6 class="m-0 font-weight-bold text-primary">Rekap Data Izin Siswa</h6>
                        </div>
                        <div class="row">
                            <div class="input-group mb-3 col-md-6">
                                <label class="input-group-text" for="inputGroupSelect01">TANGGAL</label>
                                ...
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    <thead>
                                        <tr class="bg-primary text-light">
                                            ...
                                            <th class="text-center">Nama Siswa</th>
                                            <th class="text-center">Kelas</th>
                                            <th class="text-center">Tanggal S/D Tanggal</th>

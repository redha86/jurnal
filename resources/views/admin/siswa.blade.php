                ...
                <div class="container-fluid">
                    ...
                    <div class="page-title">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">Yang Magang Di Hummasoft</li>
                        </ol>
                    </div>
                            ...
                            <div class="card border-bottom-success shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-secondari text-uppercase mb-1 text-left">
                                                <span>NISN :</span>
                                                {{ $p->nisn }}</a></div>
                                            <div class="text-xs font-weight-bold text-secondari text-uppercase mb-1 text-left">
                                                <span>Nama :</span>
                                                ...
                                                <div class="text-xs font-weight-bold text-secondari text-uppercase mb-1 text-left">
                                                    <span>Kelas :</span>
                                                    {{ $p->kelas }}</div>
                                                    <div class="text-xs font-weight-bold text-secondari text-uppercase mb-3 text-left">
                                                        <span>Tempat Magang :</span>
                                                        {{ $p->tempat }}</div>
                                                <div class="text-center">
                                                <a href="{{ url('datasiswa') }}" class="fas fa-edit bg-success text-light fs-4 p-1 rounded mx-auto"></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>

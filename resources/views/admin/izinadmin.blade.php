            ...
            <li class="nav-item active">
                ...
                <div id="collapseIzin" class="collapse show" aria-labelledby="headingIzin"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="{{ url('izinadmin') }}">Izin</a>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="page-title">
                        <h4 class="mb-3 font-size-15 font-weight-bold">Data Izin Siswa  </h4>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript: void(0);">SMK NEGERI 1 TAMBAKBOYO</a></li>
                            <li class="breadcrumb-item"><a href="javascript: void(0);">Izin hari Ini</a></li>
                        </ol>
                    </div>                   
                    <!-- Content Row -->
                    <div class="row">
                                    ...
                                    <table id="datatable-buttons"
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="text-center">senin, 23-05-2022</td>
                                                <td class="text-center"><img src="assets/img/undraw_profile.svg" width="40px" class="rounded-circle center mx-auto"></td>
                                                <td class="text-center">
                                                    <a href="#" class="bg-warning text-light fs-4 p-1 rounded">Terima</a>
                                                    <a href="#" class="bg-danger text-light fs-4 p-1 rounded">Tolak</a>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td class="text-center">Aldi Afendi</td>
                                                <td class="text-center">RPL</td>
                                                <td class="text-center">Acara keluarga</td>
                                                <td class="text-center">senin, 23-05-2022</td>
                                                <td class="text-center"><img src="assets/img/undraw_profile.svg" width="40px" class="rounded-circle center mx-auto"></td>
                                                <td class="text-center">
                                                    <a href="#" class="bg-warning text-light fs-4 p-1 rounded">Terima</a>

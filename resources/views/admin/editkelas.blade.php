            ...
            <li class="nav-item active">
                ...
                <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item  active" href="{{ url('datakelas') }}">Data Kelas</a>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="page-title">
                        <h4 class="mb-3 font-size-15 font-weight-bold">EDIT KELAS </h4>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript: void(0);">SMK NEGERI 1 TAMBAKBOYO</a></li>
                            <li class="breadcrumb-item"><a href="javascript: void(0);">Edit Kelas</a></li>
                        </ol>
                    </div>                   
                    <!--tampilan-->
                <form action="{{ url('editkelas/'.$data->id) }}" method="post" enctype="multipart/form-data">
                    @csrf
                        ...
                        <div class="col-lg-6 mx-auto">
                            <div class="card position-relative">
                                <div class="card-body border-left-primary">
                                    <div class="font-weight-bold">Pilih Kelas</div>
                                    <div class="input-group mb-3">
                                        <label class="input-group-text" for="">KELAS</label>
                                        <select class="form-select col-lg-9" id="" name="kelas" >
                                    ...
                                    <div class="font-weight-bold">Tahun Ajaran</div>
                                    <div class="input-group mb-3">
                                        <select class="form-select col-lg-5" id="" name="tahun_awal">
                                        ...
                                        <label class="input-group-text" for="">S/D</label>
                                        <select class="form-select col-lg-5" id="" name="tahun_akhir">
                                          <option value="2021">2021</option>
                                          <option value="2022">2022</option>
                                          <option value="2023">2023</option>
                                          <option value="2024">2024</option>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Pandawa</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->

...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{{ url('tambahsiswa') }}">Tambah Data Siswa</a>
            ...
            <li class="nav-item active">
                ...
                <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="{{ url('dataperusahaan') }}">Data Perusahaan</a>
                    </div>
                </div>
            </li>
            ...
            <!-- Nav Item - jurnal -->
            <li class="nav-item">
                <a class="nav-link" href="{{ url('rekapjurnal') }}">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="page-title">
                        <h4 class="mb-0 font-size-18">Data Perusahaan </h4>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item">SMK NEGERI 1 TAMBAKBOYO</li>
                            <li class="breadcrumb-item">Tambah Data Perusahaan Baru</li>
                        </ol>
                    </div>
                    <!--tambah-->
                    <a href="{{ url('tambahperusahaan') }}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm mb-4 "><i
                        class="fas fa-plus fa-sm text-light-50">Tambah Data Perusahaan</i></a>
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1 text-center">
                                                {{ $p->nama_perusahaan }}</a></div>
                                            <div class="text-xs font-weight-bold text-secondari text-uppercase mb-1 text-center">
                                                {{ $p->tanggal_awal }}-{{ $p->tanggal_akhir }}</div>
                                            <div class="text-center">
                                                <a href="{{ url('editperusahaan/'.$p->id) }}" class="fas fa-edit bg-success text-light fs-4 p-1 rounded mx-auto"></a>
                                                <a href="{{ url('hapusperusahaan/'.$p->id) }}" class="fas fa-trash-alt bg-danger text-light fs-4 p-1 rounded mx-auto"></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>

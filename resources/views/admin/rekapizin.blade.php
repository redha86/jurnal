...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - One Collapse Menu -->
            <li class="nav-item active">
                <a class="nav-link " href="#" data-toggle="collapse" data-target="#collapseIzin" aria-expanded="true"
                    aria-controls="collapseIzin">
                    <i class="fas fa-envelope-open-text"></i>
                    <span>Data Izin</span>
                </a>
                <div id="collapseIzin" class="collapse show" aria-labelledby="headingIzin"
                    data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">IZIN SISWA :</h6>
                        <a class="collapse-item " href="{{ url('izinadmin') }}">Izin</a>
                        <a class="collapse-item active" href="{{ url('rekapizin') }}">Rekap Izin</a>
                    </div>
                </div>
            </li>
